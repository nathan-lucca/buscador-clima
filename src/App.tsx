...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-700 to-cyan-600 flex flex-col items-center justify-center px-4 gap-6">
      <div className="text-center mb-2">
        <h1 className="text-4xl font-bold text-white">Clima Agora</h1>
        <p className="text-white/60 mt-1 text-sm">
          Busque o clima de qualquer cidade
        </p>
      </div>
